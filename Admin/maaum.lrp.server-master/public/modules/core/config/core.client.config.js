...
angular.module('core').run(['Menus',
  function(Menus) {
    ...
    Menus.addMenuItem('sidebar', '치료사 관리', 'therapist/list', 'dropdown', '/therapist(/.*)?', false, ['admin', 'manager'], 5, 'fa fa-user-md');
    Menus.addSubMenuItem('sidebar', 'therapist/list', '치료사 목록', 'therapist/list');
    Menus.addSubMenuItem('sidebar', 'therapist/list', '치료사 등록', 'therapist/signup');
